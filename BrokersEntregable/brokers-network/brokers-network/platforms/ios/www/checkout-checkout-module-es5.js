...
module.exports = ".welcome-card ion-img {\n  max-height: 35vh;\n  overflow: hidden;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CheckoutPage = /** @class */ (function () {
    function CheckoutPage(http, payPal, emailComposer, rs, loading, alertCtrl, navCtrl) {
        this.http = http;
        this.payPal = payPal;
    ...
    CheckoutPage.prototype.enviarSolicitud = function () {
        var _this = this;
        var email_to = "";
        var body = "";
        ...
        switch (this.productoAVer) {
            case "Documentación Aval":
                ...
                break;
            case "Apoyo en citas y recorridos":
            ...
            case "Estudio de mercado":
                ...
                body = "Me interesa recibir más información sobre " + this.productoAVer +
                    ...
                    "\n<br>Cel: " + user_info.celular;
                break;
            case "Subir propiedad a portales inmobiliarios":
                email_to = "oficina@brokersnetwork.mx";
                body = "Me interesa recibir más información sobre " + this.productoAVer +
                    "\n<br><br>Nombre: " + user_info.nombreApellido +
                    "\n<br>Email: " + user_info.email +
        ...
        this.http.post(this.rs.ROOTURL + "Pagos/agregarPago.php", {
            ...
            var email = {
                ...
                subject: 'Formulario de ' + _this.productoAVer,
                body: body,
                isHtml: true
            };
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.payPal.init({
                    ...
                    _this.payPal.prepareToRender('PayPalEnvironmentSandbox', new _ionic_native_paypal_ngx__WEBPACK_IMPORTED_MODULE_4__["PayPalConfiguration"]({
                    // Only needed if you get an "Internal Service Error" after PayPal login!
                    //payPalShippingAddressOption: 2 // PayPalShippingAddressOptionPayPal
                    })).then(function () {
                        var payment = new _ionic_native_paypal_ngx__WEBPACK_IMPORTED_MODULE_4__["PayPalPayment"](_this.paymentAmount, _this.currency, 'Description', 'sale');
                        _this.payPal.renderSinglePaymentUI(payment).then(function (res) {
                            _this.http.setRequestTimeout(5.0);
                            _this.http.post(_this.rs.ROOTURL + "Pagos/agregarPago.php", {
                                "pago": JSON.stringify(res),
                                "id_usuario": window.localStorage.getItem("id_usuario"),
                                "producto": _this.productoAVer,
                                "descripcion": _this.descripcionAVer,
                                "precio": _this.precioAVer,
                            }, { 'Accept': 'application/x-www-form-urlencoded', 'Content-Type': 'application/x-www-form-urlencoded' })
                                .then(function (data) {
    ...
    CheckoutPage.prototype.irPoliticas = function () {
    };
    CheckoutPage.prototype.irTerminos = function () {
    };
