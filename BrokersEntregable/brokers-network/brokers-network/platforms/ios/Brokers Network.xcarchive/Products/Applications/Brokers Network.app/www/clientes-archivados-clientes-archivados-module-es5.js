...
var ClientesArchivadosPageRoutingModule = /** @class */ (function () {
    function ClientesArchivadosPageRoutingModule() {
    }
    ...
    return ClientesArchivadosPageRoutingModule;
}());
...
var ClientesArchivadosPageModule = /** @class */ (function () {
    function ClientesArchivadosPageModule() {
    }
    ...
    return ClientesArchivadosPageModule;
}());
...
var ClientesArchivadosPage = /** @class */ (function () {
    function ClientesArchivadosPage(alertCtrl, http, rs, loadingController, alertController, navCtrl) {
    ...
    ClientesArchivadosPage.prototype.ngOnInit = function () {
    };
    ClientesArchivadosPage.prototype.ionViewDidEnter = function () {
        this.getClientes();
    };
    ClientesArchivadosPage.prototype.presentLoading = function () {
    ...
    ClientesArchivadosPage.prototype.getClientes = function () {
        var _this = this;
        this.presentLoading();
        ...
        this.http.post(this.rs.ROOTURL + "Clientes/getClientes.php", {
            ...
            _this.filteredclientes = _this.clientes.filter(function (t) { return (t.archivado == 1); });
    ...
    ClientesArchivadosPage.prototype.desarchivarCliente = function (id_cliente) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alerta;
            var _this = this;
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function (data) {
                                        ...
                                        _this.http.post(_this.rs.ROOTURL + "Clientes/desarchivarCliente.php", {
    ...
    ClientesArchivadosPage.prototype.eliminarCliente = function (id_cliente) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alerta;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ClientesArchivadosPage.ctorParameters = function () { return [
...
//# sourceMappingURL=clientes-archivados-clientes-archivados-module-es5.js.map