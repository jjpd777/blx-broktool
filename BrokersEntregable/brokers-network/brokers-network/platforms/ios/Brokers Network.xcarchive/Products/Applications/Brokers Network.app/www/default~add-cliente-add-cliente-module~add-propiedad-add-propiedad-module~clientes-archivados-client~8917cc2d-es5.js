(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~add-cliente-add-cliente-module~add-propiedad-add-propiedad-module~clientes-archivados-client~8917cc2d"],{
...
var ButtonFabComponent = /** @class */ (function () {
    ...
    ButtonFabComponent.prototype.ngOnInit = function () { };
...
var FooterBlueComponent = /** @class */ (function () {
    function FooterBlueComponent(iab) {
        this.iab = iab;
    }
    FooterBlueComponent.prototype.ngOnInit = function () { };
    FooterBlueComponent.prototype.openLink = function () {
        this.iab.create("https://www.brokersnetwork.mx/", "_system");
    };
    FooterBlueComponent.ctorParameters = function () { return [
...
var FooterComponent = /** @class */ (function () {
    function FooterComponent(iab, keyboard, platform) {
        this.iab = iab;
    ...
    FooterComponent.prototype.openLink = function () {
        this.iab.create("https://www.brokersnetwork.mx/", "_system");
    };
...
var MenuRegistroComponent = /** @class */ (function () {
    function MenuRegistroComponent() {
        this.urlLogo = '/assets/images/logoB.png';
    }
    MenuRegistroComponent.prototype.ngOnInit = function () { };
...
//# sourceMappingURL=default~add-cliente-add-cliente-module~add-propiedad-add-propiedad-module~clientes-archivados-client~8917cc2d-es5.js.map