...
var WhatsappPageRoutingModule = /** @class */ (function () {
    function WhatsappPageRoutingModule() {
    }
...
module.exports = ".button__siguiente {\n  text-align: center;\n  border-radius: 50px;\n  background-color: #094f72;\n  color: white;\n  font-weight: 700;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var WhatsappPage = /** @class */ (function () {
    function WhatsappPage(navCtrl, http, loadingController, rs, contacts) {
    ...
    WhatsappPage.prototype.ionViewDidEnter = function () {
    ...
    WhatsappPage.prototype.buscarContacto = function () {
        var _this = this;
        ...
        this.contacts.pickContact().then(function (contacto) {
            ...
            console.log("this.telefono_contacto", _this.telefono_contacto);
            if (_this.telefono_contacto == "") {
                alert("Este contacto no tiene un teléfono movil asignado.");
            }
            else {
                _this.mensaje.contacto = "" + _this.nombre_contacto + " - " + _this.telefono_contacto;
            }
        });
    };
    WhatsappPage.prototype.goBack = function () {
        this.navCtrl.pop();
    };
    WhatsappPage.prototype.enviarWhatsapp = function () {
        var link = "";
    ...
    WhatsappPage.ctorParameters = function () { return [
...
//# sourceMappingURL=whatsapp-whatsapp-module-es5.js.map