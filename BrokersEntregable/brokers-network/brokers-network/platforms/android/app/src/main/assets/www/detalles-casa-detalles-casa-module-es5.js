...
var DetallesCasaPageRoutingModule = /** @class */ (function () {
    function DetallesCasaPageRoutingModule() {
    }
    ...
    return DetallesCasaPageRoutingModule;
}());
...
var DetallesCasaPageModule = /** @class */ (function () {
    function DetallesCasaPageModule() {
    }
...
var DetallesCasaPage = /** @class */ (function () {
    function DetallesCasaPage(localeService, menuCtrl, http, rs, navCtrl, loadingController, alertCtrl, loading, calendar, iab) {
    ...
    DetallesCasaPage.prototype.verPropiedad = function (propiedad, event) {
        event.stopPropagation();
        window.localStorage.setItem("propiedad_a_ver", JSON.stringify(propiedad));
        this.navCtrl.navigateRoot('/editar-propiedad');
    };
    DetallesCasaPage.prototype.ngOnInit = function () {
    };
    DetallesCasaPage.prototype.cancelarPropiedad = function () {
    ...
    DetallesCasaPage.prototype.verInfo = function (titulo, msj) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    DetallesCasaPage.prototype.ionViewDidEnter = function () {
    ...
    DetallesCasaPage.prototype.showLoader = function () {
        this.loading.present();
    };
    DetallesCasaPage.prototype.abrirWhatsapp = function (p, msj, propiedad) {
        //var link = "";
        /*    if(propiedad)
            {
    ...
    DetallesCasaPage.prototype.updateEval = function () {
    ...
    DetallesCasaPage.prototype.crearComision = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alerta;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DetallesCasaPage.prototype.abrirFormulario = function (tipo) {
    ...
    DetallesCasaPage.prototype.irCheckout = function (txt, precio, descrip) {
    ...
    DetallesCasaPage.prototype.agendarCita = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        d_ = new Date();
                        y = d_.getFullYear();
                        m = getTwoDigit(d_.getMonth() + 1);
                        d = getTwoDigit(d_.getDate());
                                        ...
                                        handler: function (data) {
                                            ...
                                            try {
                                                if (data.titulo != "" && startDate instanceof Date && !isNaN(startDate.getTime()) && endDate instanceof Date && !isNaN(endDate.getTime())) {
                                                    _this.calendar.createEventInteractively(data.titulo, data.lugar, data.notas, startDate, endDate).then(function (msg) { console.log("msg", msg); }, function (err) { console.log("err", err); });
                                                }
                                                else {
    ...
    DetallesCasaPage.prototype.abrirLink = function (link) {
        this.iab.create(link, "_system");
    };
    DetallesCasaPage.prototype.abrirLinkExterno = function (tittle, msg, boton, linkExterno) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    text: boton,
                                    handler: function (data) {
                                        _this.iab.create(linkExterno, "_system");
                                    }
                                },
                                {
                                    text: 'Cerrar',
    ...
    DetallesCasaPage.prototype.archivarPropiedad = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alerta;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DetallesCasaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=detalles-casa-detalles-casa-module-es5.js.map