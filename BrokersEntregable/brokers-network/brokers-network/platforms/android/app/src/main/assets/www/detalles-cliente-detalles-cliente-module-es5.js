...
var DetallesClientePageRoutingModule = /** @class */ (function () {
    function DetallesClientePageRoutingModule() {
    }
    ...
    return DetallesClientePageRoutingModule;
}());
...
var DetallesClientePageModule = /** @class */ (function () {
    function DetallesClientePageModule() {
    }
    ...
    return DetallesClientePageModule;
}());
...
var DetallesClientePage = /** @class */ (function () {
    function DetallesClientePage(localeService, menuCtrl, http, rs, navCtrl, loadingController, alertCtrl, calendar, iab) {
    ...
    DetallesClientePage.prototype.editarCliente = function (cliente) {
        window.localStorage.setItem("cliente_a_ver", JSON.stringify(cliente));
        this.navCtrl.navigateRoot('/editar-cliente');
    };
    DetallesClientePage.prototype.abrirFormulario = function (tipo) {
    ...
    DetallesClientePage.prototype.ngOnInit = function () {
    };
    DetallesClientePage.prototype.cancelarPropiedad = function () {
                                ...
                                },
                                {
                                    ...
                                    handler: function (data) {
                                        ...
                                        _this.http.post(_this.rs.ROOTURL + "Propiedades/cancelarPropiedad.php", {
                                            "id_propiedad": _this.cliente.id_propiedad
                                            ...
                                            _this.navCtrl.navigateRoot('/clientes');
                                        })
    ...
    DetallesClientePage.prototype.verInfo = function (titulo, msj) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    DetallesClientePage.prototype.ionViewDidEnter = function () {
    ...
    DetallesClientePage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    DetallesClientePage.prototype.showLoader = function () {
        this.presentLoading();
    };
    DetallesClientePage.prototype.abrirWhatsapp = function (p, msj) {
        //var link = "";
    ...
    DetallesClientePage.prototype.updateEval = function () {
        var _this = this;
        //this.showLoader();
    ...
    DetallesClientePage.prototype.agendarCita = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alerta;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DetallesClientePage.prototype.crearComision = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alerta;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function (data) {
                                        ...
                                        _this.http.setRequestTimeout(5.0);
                                        _this.http.post(_this.rs.ROOTURL + "Comisiones/subirComisionCliente.php", {
                                            "monto": data.monto,
                                            "id_usuario": window.localStorage.getItem("id_usuario"),
                                            "id_cliente": _this.cliente.id_cliente,
                                            "renta_o_venta": _this.cliente.renta_o_venta
                                        }, { 'Accept': 'application/x-www-form-urlencoded', 'Content-Type': 'application/x-www-form-urlencoded' })
                                            .then(function (data) {
    ...
    DetallesClientePage.prototype.abrirLink = function (link) {
        this.iab.create(link, "_system");
    };
    DetallesClientePage.prototype.abrirLinkExterno = function (tittle, msg, boton, linkExterno) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DetallesClientePage.prototype.archivarCliente = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alerta;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DetallesClientePage.prototype.irCheckout = function (txt, precio, descrip) {
    ...
    DetallesClientePage.ctorParameters = function () { return [
...
//# sourceMappingURL=detalles-cliente-detalles-cliente-module-es5.js.map