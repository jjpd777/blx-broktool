...
module.exports = ".button__siguiente {\n  text-align: center;\n  border-radius: 50px;\n  background-color: #094f72;\n  color: white;\n  font-weight: 700;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var FormularioPage = /** @class */ (function () {
    function FormularioPage(navCtrl, http, loadingController, rs, emailComposer) {
    ...
    FormularioPage.prototype.presentLoading = function () {
    ...
    FormularioPage.prototype.showLoader = function () {
        this.presentLoading();
    };
    FormularioPage.prototype.ngOnInit = function () {
    };
    FormularioPage.prototype.ionViewDidEnter = function () {
    ...
    FormularioPage.prototype.guardarFormulario = function () {
        var _this = this;
        this.showLoader();
        ...
        this.http.post(this.rs.ROOTURL + formulario_php + "/updateFormulario.php", {
            ...
            if (_this.formularioAVer == "Informe de Visita") {
                if (_this.tipoFormularioAVer == "Cliente") {
                    _this.cliente.formulario_informe_visita = _this.formulario_informe_visita;
                }
                if (_this.tipoFormularioAVer == "Propiedad") {
                    _this.propiedad.formulario_informe_visita = _this.formulario_informe_visita;
                }
            }
            if (_this.formularioAVer == "Conseguir el Cliente") {
                _this.cliente.formulario_conseguir_cliente = _this.formulario_conseguir_cliente;
            }
            if (_this.formularioAVer == "Conseguir la Propiedad") {
                _this.propiedad.formulario_conseguir_propiedad = _this.formulario_conseguir_propiedad;
            }
            if (_this.formularioAVer == "Documentación para Renta") {
                _this.propiedad.formulario_documentacion_venta = _this.formulario_documentacion_venta;
            }
            if (_this.formularioAVer == "Documentación para Renta") {
                _this.propiedad.formulario_documentacion_venta = _this.formulario_documentacion_venta;
            }
            if (_this.formularioAVer == "Contrato para Renta") {
                _this.propiedad.formulario_contrato_renta = _this.formulario_contrato_renta;
            }
            if (_this.tipoFormularioAVer == "Cliente") {
    ...
    FormularioPage.prototype.goBack = function () {
        this.navCtrl.pop();
    };
    FormularioPage.prototype.enviarFormulario = function () {
        //this.showLoader();
        var body;
        var datos_cliente = "";
        if (this.formularioAVer == "Conseguir el Cliente") {
...
//# sourceMappingURL=formulario-formulario-module-es5.js.map